    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      <div className="w-full max-w-md bg-gray-800 text-white rounded-lg shadow-lg p-8">
        ...
        <form className="space-y-4">
          ...
          <div>
            <label htmlFor="confirm" className="block text-sm mb-1">Contraseña</label>
            <input type="password" id="confirm" className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="••••••••" />
          </div>
        ...
        <p className="text-center text-sm mt-6 text-gray-400">
          ¿ya tienes cuenta? <a href="#" className="text-blue-400 hover:underline">Inicia sesion</a>
        </p>
      </div>
    </div>
    </>
